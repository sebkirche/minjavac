...
public class ManualParser implements ParserConstants {
  public static void main (String[] args) throws Exception {
    ManualParser parser = null;

    if (args.length == 1) {
        parser = new ManualParser(new java.io.FileInputStream(args[0]));
    }
    else if (args.length == 0) {
      parser = new ManualParser(System.in);
    }
    else {
  ...
  public ManualParser(InputStream input) {
